    ...
    switch (this.lang.language) {
      case 'ru':{
        switch (input) {
          ...
          case 'Ready to Delivery': return styled ? '<span style="color: #393346; background-color: #cbc4d7; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 12px; letter-spacing: .3px;">Готов к поставке</span>' : 'Готов к поставке';
          case 'Delivered': return styled ? '<span style="color: #454955; background-color: #dae4ff; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 12px; letter-spacing: .3px;">Поставлен</span>' : 'Поставлен';
          ...
          case 'Approved by RS': return styled ? '<span style="color: #ab433f; background-color: #fde0e0; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 12px; letter-spacing: .3px;">Согласовано в РС</span>' : 'Согласовано в РС';
      ...
      default:{
        switch (input) {
          ...
          case 'On reApproval': return styled ? '<span style="color: #813A18; background-color: #FFB38F; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 12px; letter-spacing: .3px;">On reApproval</span>' : 'Retry Approval';
    ...
    switch (this.lang.language) {
      case 'ru':{
        switch (input) {
          ...
          case 'Assign responsible': return styled ? '<div class="buttons-pick-problem"><span class="icon-problem cxy"><img src="assets/icons/problem.svg" height="18"></span><span class="cxy button-text">Назначить ответственного</span></div>' : 'Назначить ответственного';
      ...
      default:{
        switch (input) {
          ...
          case 'Assign responsible': return styled ? '<div class="buttons-pick-problem"><span class="icon-problem cxy"><img src="assets/icons/problem.svg" height="18"></span><span class="cxy button-text">Assign responsible</span></div>' : 'Assign responsible';
