    ...
    switch (this.lang.language) {
      ...
      default:{
        switch (input) {
          ...
          case 'In Rework': return styled ? '<span style="color: #a3392b; background-color: #F5BBB2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 10px; letter-spacing: .3px;">In Rework</span>' : 'In Rework';
