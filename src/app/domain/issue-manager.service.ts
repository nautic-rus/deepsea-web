...
export class IssueManagerService {
  ...
  localeStatusAsButton(input: string, styled = true): string {
    switch (input) {
      ...
      case 'Check': return styled ? '<div class="buttons-pick-close"><span class="icon-close cxy"><img src="assets/close-task.svg"></span><span class="cxy button-text">Закрыть</span></div>' : 'На проверку';
