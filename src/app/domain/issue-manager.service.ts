    ...
    switch (this.lang.language) {
      case 'ru':{
        switch (input) {
          ...
          case 'Sent to Owner': return styled ? '<span style="color: #686e46; background-color: #e1efa1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 10px; letter-spacing: .3px;">Отправлен заказчику</span>' : 'Отправлен заказчику';
