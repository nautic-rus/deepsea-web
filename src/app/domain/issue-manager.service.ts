...
export class IssueManagerService {
  ...
  localeStatus(input: string, styled = true): string {
    switch (this.lang.language) {
      case 'ru':{
        switch (input) {
          case 'In Work': return styled ? '<span style="color: #256029; background-color: #c8e6c9; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">В работе</span>' : 'В работе';
          case 'Resolved': return styled ? '<span style="color: #805b36; background-color: #ffd8b2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Исполнено</span>' : 'Исполнено';
          case 'New': return styled ? '<span style="color: #23547b; background-color: #b3e5fc; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Новый</span>' : 'Новый';
          case 'Rejected': return styled ? '<span style="color: #c63737; background-color: #ffcdd2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Отклонено</span>' : 'Отклонено';
          case 'Check': return styled ? '<span style="color: #694382; background-color: #eccfff; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">На проверке</span>' : 'На проверке';
          case 'In Rework': return styled ? '<span style="color: #3f6b73; background-color: #cbebf1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">На доработке</span>' : 'На доработке';
          case 'Paused': return styled ? '<span style="color: #8a5340; background-color: #feedaf; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Приостановлено</span>' : 'Приостановлено';
          case 'Archive': return styled ? '<span style="color: #8a5340; background-color: #feedaf; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Архив</span>' : 'Архив';
          case 'Not resolved': return styled ? '<span style="color: #8a5340; background-color: #feedaf; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Не исполнено</span>' : 'Не исполнено';
          case 'Closed': return styled ? '<span style="color: #454955; background-color: #dae4ff; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Закрыто</span>' : 'Закрыто';
          case 'Send to Approval': return styled ? '<span style="color: #805b36; background-color: #ffd8b2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">На согласовании</span>' : 'На согласовании';
          case 'Approved': return styled ? '<span style="color: #2e604b; background-color: #ceede1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Согласовано</span>' : 'Согласовано';
          case 'Not Approved': return styled ? '<span style="color: #a3392b; background-color: #F5BBB2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Не согласовано</span>' : 'Не согласовано';
          case 'Ready to Send': return styled ? '<span style="color: #4A7863; background-color: #DCEFED; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Готов к отправке</span>' : 'Готов к отправке';
          case 'On reApproval': return styled ? '<span style="color: #813A18; background-color: #FFB38F; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Повторное согласование</span>' : 'Повторное согласование';
          case 'Send to Yard Approval': return styled ? '<span style="color: #895169; background-color: #f8c1d5; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Отправлен на верфь</span>' : 'Отправлен на верфь';
          case 'Ready to Delivery': return styled ? '<span style="color: #393346; background-color: #cbc4d7; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Готов к поставке</span>' : 'Готов к поставке';
          case 'Delivered': return styled ? '<span style="color: #454955; background-color: #dae4ff; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Поставлен</span>' : 'Поставлен';
          case 'Send to RS': return styled ? '<span style="color: #082128; background-color: #cee4eb; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Отправлен в РС</span>' : 'Отправлен в РС';
          case 'Approved by RS': return styled ? '<span style="color: #ab433f; background-color: #fde0e0; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Согласовано в РС</span>' : 'Согласовано в РС';
          case 'Send to Owner': return styled ? '<span style="color: #686e46; background-color: #e1efa1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Отправлен заказчику</span>' : 'Отправлен заказчику';
          case 'AssignedTo': return styled ? '<span style="color: #606a33; background-color: #dbe9a0; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Назначен</span>' : 'Назначен';
          case 'Comments fixed': return styled ? '<span style="color: #9d7900; background-color: #ffefb2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Замечания устранены</span>' : 'Замечания устранены';
          case 'Cancel': return styled ? '<span style="color: #c63737; background-color: #ffcdd2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Аннулирован</span>' : 'Аннулирован';
          case 'To publish': return styled ? '<span style="color: #9C6480; background-color: #F2CFE2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">На публикации</span>' : 'На публикации';
          case 'Published': return styled ? '<span style="color: #7D588C; background-color: #DFC9E7; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Опубликовано</span>' : 'Опубликовано';
          case 'Accepted': return styled ? '<span style="color: #5D7991; background-color: #C6D8E8; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Принято</span>' : 'Принято';
          case 'Hold': return styled ? '<span style="color: #9d4c22; background-color: #fc763585; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">На удержании</span>' : 'На удержании';
          case 'Assign responsible': return styled ? '<span style="color: #686e46; background-color: #e1efa1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Назначен ответственный</span>' : 'Назначен ответственный';
          case 'Joined': return styled ? '<span style="color: #07594D; background-color: #067b6b40; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Объединен</span>' : 'Объединен';
          case 'Checked': return styled ? '<span style="color: #507667; background-color: #82d8b596; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Проверено</span>' : 'Проверено';
      ...
      default:{
        switch (input) {
          case 'In Work': return styled ? '<span style="color: #256029; background-color: #c8e6c9; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">In Work</span>' : 'In Work';
          case 'Resolved': return styled ? '<span style="color: #805b36; background-color: #ffd8b2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Resolved</span>' : 'Resolved';
          case 'New': return styled ? '<span style="color: #23547b; background-color: #b3e5fc; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">New</span>' : 'New';
          case 'Rejected': return styled ? '<span style="color: #c63737; background-color: #ffcdd2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Rejected</span>' : 'Rejected';
          case 'Check': return styled ? '<span style="color: #694382; background-color: #eccfff; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">On Check</span>' : 'On Check';
          case 'In Rework': return styled ? '<span style="color: #3f6b73; background-color: #cbebf1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">In Rework</span>' : 'In Rework';
          case 'Paused': return styled ? '<span style="color: #8a5340; background-color: #feedaf; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Paused</span>' : 'Paused';
          case 'Archive': return styled ? '<span style="color: #8a5340; background-color: #feedaf; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Archive</span>' : 'Archive';
          case 'Not resolved': return styled ? '<span style="color: #8a5340; background-color: #feedaf; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Not resolved</span>' : 'Not resolved';
          case 'Closed': return styled ? '<span style="color: #454955; background-color: #dae4ff; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Closed</span>' : 'Closed';
          case 'Send to Approval': return styled ? '<span style="color: #805b36; background-color: #ffd8b2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">On Approval</span>' : 'On Approval';
          case 'Approved': return styled ? '<span style="color: #2e604b; background-color: #ceede1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Approved</span>' : 'Approved';
          case 'Not Approved': return styled ? '<span style="color: #a3392b; background-color: #F5BBB2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Not Approved</span>' : 'Not Approved';
          case 'Ready to Send': return styled ? '<span style="color: #3e6654; background-color: #DCEFED; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Ready to Send</span>' : 'Ready to Send';
          case 'On reApproval': return styled ? '<span style="color: #813A18; background-color: #FFB38F; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">On reApproval</span>' : 'Retry Approval';
          case 'Send to Yard Approval': return styled ? '<span style="color: #895169; background-color: #f8c1d5; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Sent to shipyard</span>' : 'Sent to shipyard';
          case 'Ready to Delivery': return styled ? '<span style="color: #393346; background-color: #cbc4d7; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Ready to delivery</span>' : 'Ready to delivery';
          case 'Delivered': return styled ? '<span style="color: #454955; background-color: #dae4ff; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Delivered</span>' : 'Delivered';
          case 'Send to RS': return styled ? '<span style="color: #082128; background-color: #cee4eb; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Sent to RS</span>' : 'Sent to RS';
          case 'Approved by RS': return styled ? '<span style="color: #ab433f; background-color: #fde0e0; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Approved by RS</span>' : 'Approved by RS';
          case 'Send to Owner': return styled ? '<span style="color: #686e46; background-color: #e1efa1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Sent to Owner</span>' : 'Sent to Owner';
          case 'AssignedTo': return styled ? '<span style="color: #606a33; background-color: #dbe9a0; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Assigned</span>' : 'Assigned';
          case 'Comments fixed': return styled ? '<span style="color: #9d7900; background-color: #ffefb2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Comments fixed</span>' : 'Comments fixed';
          case 'Cancel': return styled ? '<span style="color: #c63737; background-color: #ffcdd2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Cancel</span>' : 'Cancel';
          case 'To publish': return styled ? '<span style="color: #9C6480; background-color: #F2CFE2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">To publish</span>' : 'To publish';
          case 'Published': return styled ? '<span style="color: #7D588C; background-color: #DFC9E7; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Published</span>' : 'Published';
          case 'Accepted': return styled ? '<span style="color: #5D7991; background-color: #C6D8E8; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Accepted</span>' : 'Accepted';
          case 'Hold': return styled ? '<span style="color: #9d4c22; background-color: #fc763585; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Hold</span>' : 'Hold';
          case 'Assign responsible': return styled ? '<span style="color: #686e46; background-color: #e1efa1; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Assign responsible</span>' : 'Assign responsible';
          case 'Joined': return styled ? '<span style="color: #07594D; background-color: #067b6b40; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Joined</span>' : 'Joined';
          case 'Checked': return styled ? '<span style="color: #507667; background-color: #82d8b596; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 11px; letter-spacing: .3px;">Checked</span>' : 'Checked';
