    ...
    switch (this.lang.language) {
      case 'ru':{
        switch (input) {
          ...
          case 'To reApproval': return styled ? '<div class="buttons-pick-reapproval"><span class="icon-reapproval cxy"><img src="assets/icons/approval.svg" height="18"></span><span class="cxy button-text">Повторное согласование</span></div>' : 'Повторное согласование';
      ...
      default:{
        switch (input) {
          ...
          case 'To reApproval': return styled ? '<div class="buttons-pick-reapproval"><span class="icon-reapproval cxy"><img src="assets/icons/approval.svg" height="18"></span><span class="cxy button-text">reApproval</span></div>' : 'reApproval';
