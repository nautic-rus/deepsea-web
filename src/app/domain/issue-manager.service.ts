    ...
    switch (this.lang.language) {
      case 'ru':{
        switch (input) {
          ...
          case 'Approved with comments': return styled ? '<span style="color: #9d7900; background-color: #ffefb2; border-radius: 2px; padding: 2px 4px; text-transform: uppercase; font-weight: 700; font-size: 10px; letter-spacing: .3px;">Одобрено с комментариями</span>' : 'Одобрено с комментариями';
    ...
    switch (this.lang.language) {
      case 'ru':{
        switch (input) {
          ...
          case 'Approved with comments': return styled ? '<div class="buttons-pick-pause"><span class="icon-pause cxy"><img src="assets/icons/like.svg"></span><span class="cxy button-text">Согласовано с комментариями</span></div>' : 'Согласовано с комментариями';
